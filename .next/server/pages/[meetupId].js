...
module.exports = {
	...
	"title": "MeetupDetail_title__2__hE",
	"address": "MeetupDetail_address__3mbvO"
};
...
function MeetupDetail(props) {
  return /*#__PURE__*/Object(jsx_runtime_["jsxs"])("section", {
    ...
    children: [/*#__PURE__*/Object(jsx_runtime_["jsx"])("img", {
      ...
      className: MeetupDetail_module_default.a.title,
      children: props.title
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("address", {
      className: MeetupDetail_module_default.a.address,
      children: props.address
    }), /*#__PURE__*/Object(jsx_runtime_["jsx"])("p", {
      className: MeetupDetail_module_default.a.description,
...
async function getStaticPaths() {
  const client = await external_mongodb_["MongoClient"].connect('mongodb+srv://alexisiquintuna:Emilyd120599@cluster0.j7ogy.mongodb.net/meetups?retryWrites=true&w=majority');
  const db = client.db();
